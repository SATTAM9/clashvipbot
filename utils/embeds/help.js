...
const getGeneralHelp = () => new EmbedBuilder()
    .setTitle("Guide to use Clashvip")
    .setColor('#34C6EB')
    .setDescription(
        `Clashvip enables you to verify and connect your Clash of Clans account to the discord server! To get more information on a specific feature, type \`/help command\` and enter one of the subcommands below.`)
    .addFields({
...
const getVerificationHelp = () => new EmbedBuilder()
    ...
    .setColor('#34C6EB')
    .setDescription(
        `Verification allows Clashvip to know you own the corresponding Clash of Clans account. A list of commands for verifying can be found below:`)
    .addFields({
...
const getStatsHelp = () => new EmbedBuilder()
    ...
    .setColor('#34C6EB')
    .setDescription(
        `Clashvip lets you see in-game statistics of player profiles and clans. It shows whether you verified under an account, but is not necessary.`)
    .addFields({
